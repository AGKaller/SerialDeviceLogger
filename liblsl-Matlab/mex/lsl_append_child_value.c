...
/* function [DescPtr] = lsl_append_child_value(LibHandle,DescPtr,Name,Value) */
		  ...
		  int nrhs, const mxArray*prhs[] ) 
{
    ...
    /* get function handle */
    field = mxGetField(prhs[0],0,"lsl_append_child_value");
    if (!field)
        mexErrMsgTxt("The field does not seem to exist.");
    pTmp = (uintptr_t*)mxGetData(field);
    if (!pTmp)
        mexErrMsgTxt("The field seems to be append_child_value.");
